<section class="flex items-center flex-col justify-center min-h-screen ">
    ...
    <form class="w-1/4 mx-auto" method="post" action="<?php echo $this->Html->url(array('action' => 'changePassword')); ?>" enctype="multipart/form-data">
       
        <div class="mb-5 mt-5">
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
            <input value="<?php echo isset($user['email']) ? h($user['email']) : $currentUser['email']; ?>" type="text" id="email" name="email" class="block bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
