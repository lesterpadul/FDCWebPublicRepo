    ...
    <form class="w-2/6 flex gap-2 flex-col" method="post" action="<?php echo $this->Html->url(array('action' => 'create')); ?>">
        ...
        <select id="recipients" name="recipient" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <? foreach ($users as $user): ?>
                    <option value="<? echo $user['User']['id'] ?>">
                        
                        <img class="w-8 h-8 rounded-full" src="<?php echo $this->Html->url('/' . $user['User']['profile_image']); ?>" alt="Sender's Image">
        ...
        <div class="flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
            ...
            <input id="chat" type="text" name="content" rows="3" class="block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></input>
