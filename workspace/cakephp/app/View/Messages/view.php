<section class="flex h-screen flex-col justify-center items-center w-full">
    ...
    <div class="flex items-start gap-2.5">
        ...
        <div class="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-white rounded-e-xl rounded-es-xl dark:bg-gray-700">
            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                <span class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo $messageDetail['sender_users']['sender_name'] ?></span>
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">11:46</span>
            </div>
            <p class="text-sm font-normal py-2.5 text-gray-900 dark:text-white"><?php echo $messageDetail['messages']['message'] ?></p>
    ...
    <div class="flex items-start gap-2.5">
        ...
        <div id="dropdownDots2" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-40 dark:bg-gray-700 dark:divide-gray-600">
