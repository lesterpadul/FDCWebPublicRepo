<div class="flex items-center flex-col justify-center min-h-screen">
    ...
    <div class="sticky bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid h-full w-full max-w-lg  mx-auto">
           <a href="/cakephp/messages/create" type="button" class="inline-flex flex-col items-center justify-center font-medium px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
