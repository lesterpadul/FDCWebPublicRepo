<div id="toast-danger" class="message error flex items-center w-full  p-4 mb-4 text-gray-500 bg-white rounded-lg shadow" role="alert">
    ...
    <div class="ms-3 text-sm font-normal"><?php echo h($message) ?></div>
